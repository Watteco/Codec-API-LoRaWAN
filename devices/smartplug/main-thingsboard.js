...
r.data.date+=String.fromCharCode(e[z+1+M])}}if(0===h&&16===g){var A=e[z];r.data.position="";var E=0;for(;E<A;E++){
r.data.position+=String.fromCharCode(e[z+1+E])}}if(0===h&&32769===g){var k=e[z];r.data.application_name="";var D=0
;for(;D<k;D++){r.data.application_name+=String.fromCharCode(e[z+1+D])}}if(1026===h&&0===g){var C=e[z-1]
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,_(y,h,g,e,r,z+2,C,100,"int")}
if(1026===h&&1===g&&(r.data.min_temperature=n(256*e[z]+e[z+1],2)/100),
1026===h&&2===g&&(r.data.max_temperature=n(256*e[z]+e[z+1],2)/100),1029===h&&0===g){var j=e[z-1]
;r.data.humidity=(256*e[z]+e[z+1])/100,_(y,h,g,e,r,z+2,j,100,"none")}
if(1029===h&&1===g&&(r.data.min_humidity=(256*e[z]+e[z+1])/100),
1029===h&&2===g&&(r.data.max_humidity=(256*e[z]+e[z+1])/100),15===h&&1026===g){var V=e[z-1]
;r.data.index=256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3],_(y,h,g,e,r,z+4,V,1,"none")}if(15===h&&85===g){
...
15===h&&1028===g&&(r.data.force_notify=e[z]),19===h&&85===g){var F=e[z-1];r.data.output_value=e[z],
_(y,h,g,e,r,z+1,F,1,"none")}if(6===h&&0===g){var H=e[z];r.data.output=1===H?"ON":"OFF"}if(32776===h&&0===g){var R=e[z-1]
...
;r.data.pressure=n(256*e[z]+e[z+1],2),_(y,h,g,e,r,z+2,Me,1,"int")}if(1030===h&&0===g){var Ae=e[z-1]
;r.data.occupancy=!!e[z],_(y,h,g,e,r,z+1,Ae,1,"none")}if(32850===h&&0===g){var Ee=z
...
r.data.sag_voltage=n(256*e[Ee+1]+e[Ee+2],2),Ee+=2,r.data.brownout_number=n(256*e[Ee+1]+e[Ee+2],2)}if(32783===h){
...
;if(void 0===r.data[Fe]){throw new c("bad payload1")}if(e.length<=7){throw new c("bad payload2")}}if(7===y){d=1,
