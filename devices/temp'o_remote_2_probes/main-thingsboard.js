/*temp'o_remote_2_probes v1.1.7*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
batch_counter:c.batch_counter,samples:l}}}},804:function(e,t,a){var r=a(174),n=a(912),i=[3,[{taglbl:0,resol:10,
sampletype:7,lblname:"temperature_1",divide:100},{taglbl:1,resol:10,sampletype:7,lblname:"temperature_2",divide:100},{
taglbl:5,resol:100,sampletype:6,lblname:"battery_voltage",divide:1e3}]],o={temperature:["temperature_1","temperature_2"]
...
throw new c("bad decoding")}return{type:u.batch.report,payload:u.lora.payload}}}},912:function(e){e.exports={
disposable_battery_voltage:"V",temperature_1:"Cel",temperature_2:"Cel",battery_voltage:"V"}}},t={},a=function a(r){
var n=t[r];if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports
}(804);driver=a}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports.driver=driver);
