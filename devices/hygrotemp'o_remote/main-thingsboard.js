/*hygrotemp'o_remote v1.1.7*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
358:function(e){e.exports={disposable_battery_voltage:"V",temperature:"Cel",humidity:"%RH",battery_voltage:"V"}},
...
throw new c("bad decoding")}return{type:u.batch.report,payload:u.lora.payload}}}},968:function(e,t,a){
var r=a(174),n=a(358),i=[2,[{taglbl:0,resol:10,sampletype:7,lblname:"temperature",divide:100},{taglbl:1,resol:100,
sampletype:6,lblname:"humidity",divide:100},{taglbl:2,resol:1,sampletype:6,lblname:"battery_voltage",divide:1e3},{
taglbl:3,resol:1,sampletype:1,lblname:"violation_detection",divide:1}]],o={pin_state:["violation_detection"]}
...
exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(968);driver=a}()
