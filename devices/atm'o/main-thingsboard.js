/*atm'o v1.1.7*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
322:function(e){e.exports={disposable_battery_voltage:"V",debounce_period:"ms",poll_period:"ms",temperature:"Cel",
pressure:"hPa",humidity:"%RH",battery_voltage:"V"}},652:function(e){var t=[];t[0]=0,t[1]=1,t[2]=4,t[3]=4,t[4]=8,t[5]=8,
t[6]=16,t[7]=16,t[8]=24,t[9]=24,t[10]=32,t[11]=32,t[12]=32;var a=[[{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{sz:3,lbl:5},{
sz:4,lbl:9},{sz:5,lbl:17},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{sz:11,lbl:1027},{
...
batch_counter:c.batch_counter,samples:l}}}},814:function(e,t,a){var r=a(174),n=a(322),i=[3,[{taglbl:0,resol:1,
sampletype:7,lblname:"temperature",divide:100},{taglbl:1,resol:1,sampletype:6,lblname:"humidity",divide:100},{taglbl:2,
resol:1,sampletype:7,lblname:"pressure",divide:1},{taglbl:3,resol:1,sampletype:10,lblname:"index_1",divide:1},{taglbl:4,
resol:1,sampletype:10,lblname:"index_2",divide:1},{taglbl:5,resol:1,sampletype:6,lblname:"battery_voltage",divide:1e3
}]],o={index:["index_1","index_2"],pin_state:["pin_state_1","pin_state_2"]};function s(e){
...
;r.data.pressure=n(256*e[z]+e[z+1],2),_(b,y,g,e,r,z+2,Me,1,"int")}if(1030===y&&0===g){var Ce=e[z-1]
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,Ce,1,"none")}if(32850===y&&0===g){var De=z
...
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(814)
