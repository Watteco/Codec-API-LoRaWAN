...
let batch_param =[2,[
        { taglbl: 0, resol: 0.1,   sampletype: 12,lblname: "Tilt",             divide: 1},
        { taglbl: 1, resol: 0.001, sampletype: 12,lblname: "distance",          divide: 1},
        { taglbl: 2, resol: 10,    sampletype:  7,lblname: "temperature",       divide: 100},
        { taglbl: 3, resol: 20,    sampletype:  6,lblname: "battery_voltage",   divide: 1000}]];
let endpointCorresponder={
    analog:["Tilt", "distance"],
    temperature:["acc_temperature", "temperature"]
}
