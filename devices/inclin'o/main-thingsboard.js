...
r.data.position+=String.fromCharCode(e[z+1+D])}}if(0===b&&32769===g){var A=e[z];r.data.application_name="";var E=0
;for(;E<A;E++){r.data.application_name+=String.fromCharCode(e[z+1+E])}}if(1026===b&&0===g){var j=e[z-1]
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,f(y,b,g,e,r,z+2,j,100,"int")}
