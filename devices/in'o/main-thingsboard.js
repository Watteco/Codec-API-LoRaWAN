/*in'o v1.1.7*/function _readOnlyError(e){throw new TypeError('"'+e+'" is read-only')}function _defineProperties(e,t){
...
279:function(e){e.exports={main_or_external_voltage:"V",disposable_battery_voltage:"V",debounce_period:"ms",
poll_period:"ms"}},462:function(e,t,a){var r=a(174),n=a(279),i={
...
output:["output_1","output_2","output_3","output_4"]},o=[];function s(e){
var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null
;var a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
;var s=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return t&&(o=t),a&&(i=a),
s&&(n=_objectSpread(_objectSpread({},n),s)),r.watteco_decodeUplink(e,o,i,n)}t.decodeUplink=s
;var d="undefined"!=typeof globalThis?globalThis:this;d.decodeUplink=s;var c=a(871);var l={
sendOnOffStateEP1:"1150000600<U8:sendOnOffStateEP1>",sendOnOffStateEP2:"3150000600<U8:sendOnOffStateEP2>",
sendOnOffStateEP3:"5150000600<U8:sendOnOffStateEP3>",sendOnOffStateEP4:"7150000600<U8:sendOnOffStateEP4>"}
;function u(e){return c.watteco_encodeDownlink({dlFrames:l},e)}t.encodeDownlink=u;var p=c.encodePayload
;t.encodePayload=p,d.encodeDownlink=u,d.encodePayload=p},652:function(e){var t=[];t[0]=0,t[1]=1,t[2]=4,t[3]=4,t[4]=8,
t[5]=8,t[6]=16,t[7]=16,t[8]=24,t[9]=24,t[10]=32,t[11]=32,t[12]=32;var a=[[{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{sz:3,
lbl:5},{sz:4,lbl:9},{sz:5,lbl:17},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{sz:11,
lbl:1027},{sz:11,lbl:1028},{sz:11,lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}],[{sz:7,lbl:111},{sz:5,lbl:26},{sz:4,
lbl:12},{sz:3,lbl:3},{sz:3,lbl:7},{sz:2,lbl:2},{sz:2,lbl:0},{sz:3,lbl:2},{sz:6,lbl:54},{sz:9,lbl:443},{sz:9,lbl:441},{
sz:10,lbl:885},{sz:10,lbl:884},{sz:10,lbl:880},{sz:11,lbl:1763},{sz:11,lbl:1762}],[{sz:4,lbl:9},{sz:3,lbl:5},{sz:2,lbl:0
},{sz:2,lbl:1},{sz:2,lbl:3},{sz:5,lbl:17},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{
sz:11,lbl:1027},{sz:11,lbl:1028},{sz:11,lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}]];function r(e,t,a,r){return{
uncompressSamples:[{data_relative_timestamp:r,data:{value:s(e,t),label:a}}],codingType:0,codingTable:0,resolution:null}}
function n(e,t){var a=0;for(;a<e.length;a++){if(e[a].taglbl===t.lbl){return a}}
...
var O=parseInt(u.substr(x,2),16);if(isNaN(O)){
throw new Error("Invalid hex character in template at position ".concat(x))}a.bytes.push(O)}}catch(e){
...
;var b=void 0,z=void 0,w=void 0,S=void 0,x=void 0,O=void 0,N=void 0,P=g.hasExceeded&&g.hasFallen?"exceed&fall":g.hasExceeded?"exceed":g.hasFallen?"fall":"",I=null
;if(f){if(_>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading FI.")}var U=s,T=d,E=c
;if(g.fieldIndex=0,null!=l&&!0===l&&(I=r[_++],g.fieldIndex=I,u[t]&&u[t][a]&&u[t][a][I])){var M=u[t][a][I]
;U=M.function_type||s,T=M.size||d,E=M.divider||c,O=M.name||"FieldUndef !"}b=m(U,T,E),"threshold"===g.mode&&(z=m(U,T,E))}
...
f?(N="threshold"===g.mode?void 0!==S?"cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: threshold, crossing: ").concat(P,", value: ").concat(b,", gap: ").concat(z,", occurences_up: ").concat(S,", occurences_down: ").concat(x):"cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: threshold, crossing: ").concat(P,", value: ").concat(b,", gap: ").concat(z,", occurences: ").concat(w):"cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: delta, value: ").concat(b),
O&&(N+=", field: ".concat(O)),
N+="}"):(N="cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: ").concat(g.mode),
"threshold"===g.mode&&(N+=", crossing: ".concat(P)),N+="}"),p.causesMessages.push(N)}if(_!==r.length){
...
;r.data.firmware+="."+S.toString()}if(0===h&&3===g){var x=e[z];r.data.kernel="";var O=0;for(;O<x;O++){
r.data.kernel+=String.fromCharCode(e[z+1+O])}}if(0===h&&4===g){var N=e[z];r.data.manufacturer="";var P=0;for(;P<N;P++){
r.data.manufacturer+=String.fromCharCode(e[z+1+P])}}if(0===h&&5===g){var I=e[z];r.data.model="";var U=0;for(;U<I;U++){
r.data.model+=String.fromCharCode(e[z+1+U])}}if(0===h&&6===g){var T=e[z];r.data.date="";var E=0;for(;E<T;E++){
r.data.date+=String.fromCharCode(e[z+1+E])}}if(0===h&&16===g){var M=e[z];r.data.position="";var D=0;for(;D<M;D++){
r.data.position+=String.fromCharCode(e[z+1+D])}}if(0===h&&32769===g){var C=e[z];r.data.application_name="";var j=0
;for(;j<C;j++){r.data.application_name+=String.fromCharCode(e[z+1+j])}}if(1026===h&&0===g){var k=e[z-1]
...
_(y,h,g,e,r,z+33,xe,1,"multistate",!0)}else if(32784===h&&1===g){var Oe=e[z-1]
...
_(y,h,g,e,r,z+33,Oe,1,"multistate",!0)}if(32779===h&&0===g){var Ne=z;var Pe=e[Ne-1]
;r.data.Vrms=n(256*e[Ne+1]+e[Ne+2],2)/10,Ne+=2,r.data.Irms=n(256*e[Ne+1]+e[Ne+2],2)/10,Ne+=2,
r.data.angle=n(256*e[Ne+1]+e[Ne+2],2),_(y,h,g,e,r,Ne+3,Pe,1,"multistate",!0)}if(32781===h&&0===g){var Ie=e[z-1]
...
r.data.Irms_c=n(256*e[z+15]+e[z+16],2)/10,r.data.angle_c=n(256*e[z+17]+e[z+18],2),_(y,h,g,e,r,z+19,Ie,1,"multistate",!0)
}if(32780===h&&0===g){var Ue=e[z-1];r.data.concentration=256*e[z]+e[z+1],_(y,h,g,e,r,z+2,Ue,1,"none")}
if(32780===h&&1===g&&(r.data.analog=e[z]),32780===h&&2===g&&(r.data.analog=e[z]),1024===h&&0===g){var Te=e[z-1]
;r.data.illuminance=256*e[z]+e[z+1],_(y,h,g,e,r,z+2,Te,1,"none")}if(1027===h&&0===g){var Ee=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),_(y,h,g,e,r,z+2,Ee,1,"int")}if(1030===h&&0===g){var Me=e[z-1]
;r.data.occupancy=!!e[z],_(y,h,g,e,r,z+1,Me,1,"none")}if(32850===h&&0===g){var De=z
...
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(462)
