...
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,_(y,b,g,e,r,z+2,k,100,"int")}
...
;r.data.humidity=(256*e[z]+e[z+1])/100,_(y,b,g,e,r,z+2,A,100,"none")}
...
var q=e[z-1];r.data.pin_state=!!e[z],_(y,b,g,e,r,z+1,q,1,"none")}
...
_(y,b,g,e,r,z+1,H,1,"none")}if(6===b&&0===g){var V=e[z];r.data.output=1===V?"ON":"OFF"}if(32776===b&&0===g){var R=e[z-1]
...
;r.data.pressure=n(256*e[z]+e[z+1],2),_(y,b,g,e,r,z+2,Me,1,"int")}if(1030===b&&0===g){var Ce=e[z-1]
;r.data.occupancy=!!e[z],_(y,b,g,e,r,z+1,Ce,1,"none")}if(32850===b&&0===g){var De=z
