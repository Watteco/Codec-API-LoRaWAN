...
r.data.date+=String.fromCharCode(e[z+1+M])}}if(0===b&&16===g){var D=e[z];r.data.position="";var C=0;for(;C<D;C++){
r.data.position+=String.fromCharCode(e[z+1+C])}}if(0===b&&32769===g){var E=e[z];r.data.application_name="";var j=0
;for(;j<E;j++){r.data.application_name+=String.fromCharCode(e[z+1+j])}}if(1026===b&&0===g){var A=e[z-1]
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,f(y,b,g,e,r,z+2,A,100,"int")}
...
;r.data.humidity=(256*e[z]+e[z+1])/100,f(y,b,g,e,r,z+2,k,100,"none")}
...
;r.data.pressure=n(256*e[z]+e[z+1],2),f(y,b,g,e,r,z+2,Me,1,"int")}if(1030===b&&0===g){var De=e[z-1]
;r.data.occupancy=!!e[z],f(y,b,g,e,r,z+1,De,1,"none")}if(32850===b&&0===g){var Ce=z
...
r.data.sag_voltage=n(256*e[Ce+1]+e[Ce+2],2),Ce+=2,r.data.brownout_number=n(256*e[Ce+1]+e[Ce+2],2)}if(32783===b){
