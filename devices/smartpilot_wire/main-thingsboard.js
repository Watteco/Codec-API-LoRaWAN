/*smartpilot_wire v1.1.8*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,_toPropertyKey(r.key),r)}}
function _createClass(e,t,a){return t&&_defineProperties(e.prototype,t),a&&_defineProperties(e,a),
Object.defineProperty(e,"prototype",{writable:!1}),e}function _classCallCheck(e,t){if(!(e instanceof t)){
throw new TypeError("Cannot call a class as a function")}}function _callSuper(e,t,a){return t=_getPrototypeOf(t),
_possibleConstructorReturn(e,_isNativeReflectConstruct()?Reflect.construct(t,a||[],_getPrototypeOf(e).constructor):t.apply(e,a))
...
;var u=e.recvTime;try{var p=r.normalisation_standard(e,a,s),f=p.payload;if("batch"!==p.type){return{data:i(p.data,o),
warnings:p.warning}}var _={batch1:t[0],batch2:t[1],payload:f,date:u};try{return{data:i(n.normalisation_batch(_),o),
...
var t=[];for(;e.length>=2;){t.push(parseInt(e.substring(0,2),16)),e=e.substring(2,e.length)}return t}(c)),f=function(e){
...
}}(p.getNextSample(4));u.batch_counter=p.getNextSample(4,3),p.getNextSample(4,1);var _=function(e,t,a,o,s){var d=0,c=0
...
}(u,p,s,f,e),v=_.last_timestamp,m=_.i1_of_the_first_sample;return f.hasSample&&(v=function(e,t,a,r,i,s,c){
...
timestampCommon:n,lastTimestamp:i}}(e,t,s,a),u=l.timestampCommon,p=l.lastTimestamp;var f=0
;for(;f<i.nb_of_type_measure;f++){var _=1;c.lbl=t.getNextSample(4,o);var v=n(r,c);var m=0;for(;m<s;m++){
if(t.getNextSample(4,1)){var g=t.getNextBifromHi(e.series[v].codingTable),y={data_relative_timestamp:0,data:{}}
;if(g<=14){var h=e.series[v].uncompressSamples[e.series[v].uncompressSamples.length-1].data.value;if(g>0){
y.data.value=d(t,h,e.series[v].codingType,r[v].resol,g)}else{if(_){_=0;continue}y.data.value=h}}else{
...
c.lbl=t.getNextSample(4,s);var u=n(a,c),p=t.getNextSample(4,8);if(p){var f=t.getNextSample(4,2);var _=0;for(;_<p;_++){
var v=e.series[u].uncompressSamples[e.series[u].uncompressSamples.length-1].data_relative_timestamp,m={
data_relative_timestamp:0,data:{}},g=t.getNextBifromHi(f);if(m.data_relative_timestamp=o(t,v,g),
...
e.series[u].uncompressSamples.push(m)}}}return r}(e,t,r,i,s,c)}(u,p,m,s,v,f,e)),u.batch_relative_timestamp=i(p,v),
...
}(e.batch1,e.batch2,e.payload,s),l=[];var u=0;for(;u<c.dataset.length;u++){var p=c.dataset[u],f={
variable:p.data.label_name,value:p.data.value,date:p.data_absolute_timestamp};l.push(f)}return{
...
;var p=/<([^:>]+)?:?([^>]+)>/g;var f,_=[];for(;null!==(f=p.exec(u));){var v=f[1]||null,m=f[2];_.push({type:v,name:m})}
var g=0,y=_;for(;g<y.length;g++){var h=y[g];var b=h.name,z=h.type;var w=void 0,S=void 0;if(b===n){w=t.data[n]}else{
if(void 0===t.data[b]){return a.errors=["Missing required parameter: ".concat(b)],a}w=t.data[b]}if("boolean"==typeof w){
S=w?"01":"00"}else{if("number"!=typeof w){
return a.errors=["Unsupported type for parameter ".concat(b,": ").concat(_typeof(w))],a}if(z){if("U8"===z){
...
902:function(e,t,a){var r=a(174),n=a(993),i=[],o={};function s(e){
...
;var d="undefined"!=typeof globalThis?globalThis:this;d.decodeUplink=s;var c=a(871);var l={
sendMSOMode:"11050013005520<U8:sendMSOMode>",sendMSORelay:"11050013005520<U8:sendMSORelay>"};function u(e){
return c.watteco_encodeDownlink({dlFrames:l},e)}t.encodeDownlink=u;var p=c.encodePayload;t.encodePayload=p,
d.encodeDownlink=u,d.encodePayload=p},907:function(e,t,a){
var r=a(839),n=r.UintToInt,i=r.Bytes2Float32,o=r.BytesToInt64,s=r.decimalToHex,d=r.zeroPad;r.BytesToHexStr
;var c=function(e){function t(e){var a;_classCallCheck(this,t);a=_callSuper(this,t,[e]),a.name="ValidationError"
;return a}_inherits(t,e);return _createClass(t)}(_wrapNativeSuper(Error));var l={16:{name:"boolean",size:1},8:{
...
name:"long bytes string",size:2},76:{name:"structured ordered sequence",size:2},57:{name:"single",size:4}},u={32778:{0:{
0:{divider:1,function_type:"int",name:"positive_active_energy",size:4},1:{divider:1,function_type:"int",
...
var t="",a=e.toString(2);return t+=d(a,8),t}function f(e,t,a,r,o,s,d,c,p,f){if(138===e||10==e){
var _=l[d],v=p,m=_.size,g=_.name;void 0===v&&(v="single"===g?"float":"int8"===g||"int16"===g||"int32"===g?"int":"none")
;var y=function(e,t,a,r,o,s,d,c,l){var p={reportCauses:[],causesMessages:[]}
;138===e&&p.causesMessages.push("alarm triggered");var f=o;if(f>=r.length){return p}var _=!1,v=3&(r[o]>>=4);if(2==v){
_=!0}else if(1!=v){throw new Error("Alarm decoding: Unexpected cause type. (ReportParams byte = ".concat(r[o],")"))}
if(f++,f>=r.length){return p.causesMessages.push("cause:{}"),p}function m(e,t,a){if(f+t-1>=r.length){
throw new Error("Alarm decoding: Unexpected end of data during reading of the value.")}var o=0;var s=0;for(;s<t;s++){
o=o<<8|r[f++]}if("int"===e){o=n(o,t)}else{if("float"!==e){throw new Error("Alarm decoding: Unknown type kind: "+e)}
if(4!==t){throw new Error("Alarm decoding: Invalid float size. Only 4 bytes are supported.")}o=i(o)}return o/a}
for(;f<r.length;){var g={};if(f>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading CSD.")
}var y=r[f++];g.criterionIndex=7&y;var h=y>>3&3;g.mode=1===h?"delta":2===h?"threshold":"unused",g.hasFallen=!!(32&y),
g.hasExceeded=!!(64&y),g.isAlarm=!!(128&y)
;var b=void 0,z=void 0,w=void 0,S=void 0,x=void 0,N=void 0,O=void 0,I=g.hasExceeded&&g.hasFallen?"exceed&fall":g.hasExceeded?"exceed":g.hasFallen?"fall":"",U=null
;if(_){if(f>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading FI.")}var P=s,M=d,T=c
;if(g.fieldIndex=0,null!=l&&!0===l&&(U=r[f++],g.fieldIndex=U,u[t]&&u[t][a]&&u[t][a][U])){var D=u[t][a][U]
;P=D.function_type||s,M=D.size||d,T=D.divider||c,N=D.name||"FieldUndef !"}b=m(P,M,T),"threshold"===g.mode&&(z=m(P,M,T))}
if("threshold"===g.mode&&_){if(f>=r.length){
throw new Error("Alarm decoding: Unexpected end of data before reading Occ.")}var C=r[f++];if(w=C,C>0&&128&C){
if(f+3>=r.length){throw new Error("Alarm decoding: Invalid OccH or OccL read.")}S=r[f++]<<8|r[f++],x=r[f++]<<8|r[f++]}}
p.reportCauses.push(g),
_?(O="threshold"===g.mode?void 0!==S?"cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: threshold, crossing: ").concat(I,", value: ").concat(b,", gap: ").concat(z,", occurences_up: ").concat(S,", occurences_down: ").concat(x):"cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: threshold, crossing: ").concat(I,", value: ").concat(b,", gap: ").concat(z,", occurences: ").concat(w):"cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: delta, value: ").concat(b),
N&&(O+=", field: ".concat(N)),
O+="}"):(O="cause:{alarm:".concat(g.isAlarm,", criterion_index: ").concat(g.criterionIndex,", mode: ").concat(g.mode),
"threshold"===g.mode&&(O+=", crossing: ".concat(I)),O+="}"),p.causesMessages.push(O)}if(f!==r.length){
throw new Error("Alarm decoding: Remaining unprocessed bytes detected. Expected ".concat(r.length,", but stopped at ").concat(f,"."))
}return p}(e,t,a,r,s,v,m,c,f);o.zclheader.alarmmsg=y.causesMessages}}e.exports={normalisation_standard:function(e,t){
...
;var u=e.length,_="";r.lora.payload="";var v=0;for(;v<u;v++){_=e[v].toString(16).toUpperCase(),1===_.length&&(_="0"+_),
r.lora.payload+=_;var m=new Date;r.lora.date=m.toISOString()}if(125===t){if(0==!(1&e[0])){r.zclheader={},
r.zclheader.report="standard";var g=-1,y=-1,h=-1;if(r.zclheader.endpoint=(224&e[0])>>5|(6&e[0])<<2,y=e[1],
r.zclheader.cmdID=s(y,2),h=256*e[2]+e[3],r.zclheader.clustID=s(h,4),10===y||138===y||1===y){d=1,r.data={},
g=256*e[4]+e[5],r.zclheader.attID=s(g,4);var b=e[4],z=0;if(10!==y&&138!==y||(z=7),138===y&&(r.zclheader.alarm=1),
1===y&&(z=8,r.zclheader.status=e[6]),83===h||84===h||85===h||86===h||87===h){if("function"!=typeof a){
throw new c("TIC_Decode function not found")}r.data=a(h,g,e.slice(z+1))}if(0===h&&2===g){r.data.firmware="";var w=0
;for(;w<3;w++){r.data.firmware+=String(e[z+w]),w<2&&(r.data.firmware+=".")}var S=256*e[z+3]*256+256*e[z+4]+e[z+5]
;r.data.firmware+="."+S.toString()}if(0===h&&3===g){var x=e[z];r.data.kernel="";var N=0;for(;N<x;N++){
r.data.kernel+=String.fromCharCode(e[z+1+N])}}if(0===h&&4===g){var O=e[z];r.data.manufacturer="";var I=0;for(;I<O;I++){
r.data.manufacturer+=String.fromCharCode(e[z+1+I])}}if(0===h&&5===g){var U=e[z];r.data.model="";var P=0;for(;P<U;P++){
r.data.model+=String.fromCharCode(e[z+1+P])}}if(0===h&&6===g){var M=e[z];r.data.date="";var T=0;for(;T<M;T++){
r.data.date+=String.fromCharCode(e[z+1+T])}}if(0===h&&16===g){var D=e[z];r.data.position="";var C=0;for(;C<D;C++){
r.data.position+=String.fromCharCode(e[z+1+C])}}if(0===h&&32769===g){var E=e[z];r.data.application_name="";var j=0
;for(;j<E;j++){r.data.application_name+=String.fromCharCode(e[z+1+j])}}if(1026===h&&0===g){var k=e[z-1]
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,f(y,h,g,e,r,z+2,k,100,"int")}
if(1026===h&&1===g&&(r.data.min_temperature=n(256*e[z]+e[z+1],2)/100),
1026===h&&2===g&&(r.data.max_temperature=n(256*e[z]+e[z+1],2)/100),1029===h&&0===g){var A=e[z-1]
;r.data.humidity=(256*e[z]+e[z+1])/100,f(y,h,g,e,r,z+2,A,100,"none")}
if(1029===h&&1===g&&(r.data.min_humidity=(256*e[z]+e[z+1])/100),
1029===h&&2===g&&(r.data.max_humidity=(256*e[z]+e[z+1])/100),15===h&&1026===g){var F=e[z-1]
;r.data.index=256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3],f(y,h,g,e,r,z+4,F,1,"none")}if(15===h&&85===g){
var q=e[z-1];r.data.pin_state=!!e[z],f(y,h,g,e,r,z+1,q,1,"none")}
if(15===h&&84===g&&(0===e[z]&&(r.data.polarity="normal"),1===e[z]&&(r.data.polarity="reverse")),
15===h&&1024===g&&(0===e[z]&&(r.data.edge_selection="none"),1===e[z]&&(r.data.edge_selection="falling edge"),
...
15===h&&1025===g&&(r.data.debounce_period=e[z]),15===h&&1027===g&&(r.data.poll_period=e[z]),
15===h&&1028===g&&(r.data.force_notify=e[z]),19===h&&85===g){var H=e[z-1];r.data.output_value=e[z],
f(y,h,g,e,r,z+1,H,1,"none")}if(6===h&&0===g){var V=e[z];r.data.output=1===V?"ON":"OFF"}if(32776===h&&0===g){var R=e[z-1]
;r.data.differential_pressure=256*e[z]+e[z+1],f(y,h,g,e,r,z+2,R,1,"none")}if(32773===h&&0===g){var B=e[z-1]
...
r.data.pin_state_10=!(2&~e[z]),f(y,h,g,e,r,z+2,B,100,"none")}
if(32774===h&&0===g&&(r.data.speed=256*e[z]*256+256*e[z+1]+e[z+2]),32774===h&&1===g&&(r.data.data_bit=e[z]),
32774===h&&2===g&&(r.data.parity=e[z]),32774===h&&3===g&&(r.data.stop_bit=e[z]),12===h&&85===g){var G=e[z-1]
;r.data.analog=i(256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3]),f(y,h,g,e,r,z+4,G,1,"float")}
if(12===h&&256===g&&(5===e[z+1]&&(r.data.type="ppm"),255===e[z+1]&&0===e[z+3]&&(r.data.type="mA"),
255===e[z+1]&&1===e[z+3]&&(r.data.type="mV")),12===h&&32771===g&&(r.data.power_duration=256*e[z]+e[z+1]),
12===h&&32772===g){var Y={};var L=p(e[z]),K=p(e[z+1]),X=2*L[0]+L[1];0===X&&(Y.mode="idle"),1===X&&(Y.mode="chock"),
...
if(32782===h&&0===g){var J=e[z-1];r.data.number=function(e,t,a){var r=0,o=0;switch(a){case 8:case 24:case 32:case 40:
...
var s=0;for(;s<o;s++){r=r<<8|e[t+s]}return a>=40&&a<=43?n(r,o):r}(e,z,J),f(y,h,g,e,r,z+Math.ceil(l[J].size),J,1,"none")}
if(32775===h&&1===g){r.data.modbus_payload="";var Q=e[z];var ee=0;for(;ee<Q;ee++){
_=e[z+ee+1].toString(16).toUpperCase(),
1===_.length&&(_="0"+_),0===ee?r.data.modbus_slaveID=e[z+ee+1]:1===ee?r.data.modbus_fnctID=e[z+ee+1]:2===ee?r.data.modbus_datasize=e[z+ee+1]:r.data.modbus_payload+=_
}}if(32777===h&&0===g){var te=e[z+2]<<8|e[z+3];r.data.modbus_frame_series_sent=e[z+1],
...
if(82===h&&0===g&&(r.data.active_energy=n(256*e[z+1]*256+256*e[z+2]+e[z+3],3),
...
32772===h&&0===g&&(1===e[z]&&(r.data.message_type="confirmed"),0===e[z]&&(r.data.message_type="unconfirmed")),
32772===h&&1===g&&(r.data.nb_retry=e[z]),32772===h&&2===g&&(r.data.automatic_association={},
r.data.automatic_association.period_in_minutes=256*e[z+1]+e[z+2],
r.data.automatic_association.nb_err_frames=256*e[z+3]+e[z+4]),32772===h&&3===g&&(r.data.data_rate=e[z+2]),
32772===h&&4===g){r.data.ABP_dev_address="";var oe=0;for(;oe<4;oe++){r.data.ABP_dev_address+=String(e[z+1+oe]),
oe<3&&(r.data.ABP_dev_address+=".")}}if(32772===h&&5===g){r.data.OTA_app_EUI="";var se=0;for(;se<8;se++){
r.data.OTA_app_EUI+=String(e[z+1+se]),se<7&&(r.data.OTA_app_EUI+=".")}}if(80===h&&4===g){e[z],e[z+1];var de={}
;var ce=e[z+2];var le=0;for(;le<ce;le++){var ue={};ue.endpoint=e[z+3+7*le];var pe=e[z+4+7*le];ue.input_clusters=[]
;var fe=0;for(;fe<pe;fe++){ue.input_clusters[fe]=s(256*e[z+5+7*le+2*fe]+e[z+6+7*le+2*fe],4)}var _e=e[z+5+7*le+2*pe]
;ue.output_clusters=[];var ve=0;for(;ve<_e;ve++){ue.output_clusters[ve]=s(256*e[z+6+7*le+2*ve]+e[z+7+7*le+2*ve],4)}
de[le]=ue}r.data.configuration=de}if(80===h&&6===g){var me=z+3;var ge=e[z-1]
...
16&~e[z+2]||(r.data.tic_harvesting_voltage=(256*e[me]+e[me+1])/1e3,me+=2),f(y,h,g,e,r,me+1,ge,1e3,"multistate",!0)}
if(80===h&&255===b){var ye="action "+e[5].toString();r.data[ye]="";var he=e[z+1];var be="none";var ze=0
;for(;ze<he;ze++){be+=String.fromCharCode(e[z+1+ze])}r.data[ye]=be}if(32778===h&&0===g){var we=z;var Se=e[we-1]
...
f(y,h,g,e,r,we+5,Se,1,"multistate",!0)}if(32784===h&&0===g){var xe=e[z-1]
...
f(y,h,g,e,r,z+33,xe,1,"multistate",!0)}else if(32784===h&&1===g){var Ne=e[z-1]
...
f(y,h,g,e,r,z+33,Ne,1,"multistate",!0)}if(32779===h&&0===g){var Oe=z;var Ie=e[Oe-1]
;r.data.Vrms=n(256*e[Oe+1]+e[Oe+2],2)/10,Oe+=2,r.data.Irms=n(256*e[Oe+1]+e[Oe+2],2)/10,Oe+=2,
r.data.angle=n(256*e[Oe+1]+e[Oe+2],2),f(y,h,g,e,r,Oe+3,Ie,1,"multistate",!0)}if(32781===h&&0===g){var Ue=e[z-1]
...
r.data.Irms_c=n(256*e[z+15]+e[z+16],2)/10,r.data.angle_c=n(256*e[z+17]+e[z+18],2),f(y,h,g,e,r,z+19,Ue,1,"multistate",!0)
}if(32780===h&&0===g){var Pe=e[z-1];r.data.concentration=256*e[z]+e[z+1],f(y,h,g,e,r,z+2,Pe,1,"none")}
if(32780===h&&1===g&&(r.data.analog=e[z]),32780===h&&2===g&&(r.data.analog=e[z]),1024===h&&0===g){var Me=e[z-1]
;r.data.illuminance=256*e[z]+e[z+1],f(y,h,g,e,r,z+2,Me,1,"none")}if(1027===h&&0===g){var Te=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),f(y,h,g,e,r,z+2,Te,1,"int")}if(1030===h&&0===g){var De=e[z-1]
;r.data.occupancy=!!e[z],f(y,h,g,e,r,z+1,De,1,"none")}if(32850===h&&0===g){var Ce=z
;r.data.frequency=(n(256*e[Ce+1]+e[Ce+2],2)+22232)/1e3,Ce+=2,r.data.frequency_min=(n(256*e[Ce+1]+e[Ce+2],2)+22232)/1e3,
Ce+=2,r.data.frequency_max=(n(256*e[Ce+1]+e[Ce+2],2)+22232)/1e3,Ce+=2,r.data.Vrms=n(256*e[Ce+1]+e[Ce+2],2)/10,Ce+=2,
r.data.Vrms_min=n(256*e[Ce+1]+e[Ce+2],2)/10,Ce+=2,r.data.Vrms_max=n(256*e[Ce+1]+e[Ce+2],2)/10,Ce+=2,
r.data.Vpeak=n(256*e[Ce+1]+e[Ce+2],2)/10,Ce+=2,r.data.Vpeak_min=n(256*e[Ce+1]+e[Ce+2],2)/10,Ce+=2,
r.data.Vpeak_max=n(256*e[Ce+1]+e[Ce+2],2)/10,Ce+=2,r.data.over_voltage=n(256*e[Ce+1]+e[Ce+2],2),Ce+=2,
r.data.sag_voltage=n(256*e[Ce+1]+e[Ce+2],2),Ce+=2,r.data.brownout_number=n(256*e[Ce+1]+e[Ce+2],2)}if(32783===h){
var Ee=z+1;if(0===g){var je=r.data.last={};je.NbTriggedAcq=o(e,Ee,"U32"),Ee+=4,je.Mean_X_G=o(e,Ee,"U16")/100,Ee+=2,
je.Max_X_G=o(e,Ee,"U16")/100,Ee+=2,je.Dt_X_ms=o(e,Ee,"U16"),Ee+=2,je.Mean_Y_G=o(e,Ee,"U16")/100,Ee+=2,
je.Max_Y_G=o(e,Ee,"U16")/100,Ee+=2,je.Dt_Y_ms=o(e,Ee,"U16"),Ee+=2,je.Mean_Z_G=o(e,Ee,"U16")/100,Ee+=2,
je.Max_Z_G=o(e,Ee,"U16")/100,Ee+=2,je.Dt_Z_ms=o(e,Ee,"U16")}else if(1===g||2===g||3===g){
var ke=1===g?"Stats_X":2===g?"Stats_Y":"Stats_Z",Ae=r.data[ke]={};Ae.NbAcq=o(e,Ee,"U16"),Ee+=2,
Ae.MinMean_G=o(e,Ee,"U16")/100,Ee+=2,Ae.MinMax_G=o(e,Ee,"U16")/100,Ee+=2,Ae.MinDt=o(e,Ee,"U16"),Ee+=2,
Ae.MeanMean_G=o(e,Ee,"U16")/100,Ee+=2,Ae.MeanMax_G=o(e,Ee,"U16")/100,Ee+=2,Ae.MeanDt=o(e,Ee,"U16"),Ee+=2,
Ae.MaxMean_G=o(e,Ee,"U16")/100,Ee+=2,Ae.MaxMax_G=o(e,Ee,"U16")/100,Ee+=2,Ae.MaxDt=o(e,Ee,"U16"),Ee+=2
}else if(32768===g){var Fe=r.data.params={};Fe.WaitFreq_Hz=o(e,Ee,"U16")/10,Ee+=2,Fe.AcqFreq_Hz=o(e,Ee,"U16")/10,Ee+=2
;var qe=o(e,Ee,"U16");Ee+=2,32768&qe&&(qe=60*(-32769&qe)),Fe.NewWaitDelay_s=32768&qe?qe=60*(-32769&qe):qe,
Fe.MaxAcqDuration_ms=o(e,Ee,"U16"),Ee+=2,Fe.Threshold_X_G=o(e,Ee,"U16")/100,Ee+=2,Fe.Threshold_Y_G=o(e,Ee,"U16")/100,
Ee+=2,Fe.Threshold_Z_G=o(e,Ee,"U16")/100,Ee+=2,Fe.OverThrsh_Dt_ms=o(e,Ee,"U16"),Ee+=2,Fe.UnderThrsh_Dt_ms=o(e,Ee,"U16"),
Ee+=2,Fe.Range_G=o(e,Ee,"U16")/100,Ee+=2,Fe.FilterSmoothCoef=o(e,Ee,"U8"),Ee+=1,Fe.FilterGainCoef=o(e,Ee,"U8"),Ee+=1,
Fe=r.data.Params.working_modes={},Fe.SignalEachAcq=128&e[Ee]?"true":"false",Fe.RstAftStdRpt_X=1&e[Ee]?"true":"false",
Fe.RstAftStdRpt_Y=2&e[Ee]?"true":"false",Fe.RstAftStdRpt_7=4&e[Ee]?"true":"false"}}var He=Object.keys(r.data)[0]
;if(void 0===r.data[He]){throw new c("bad payload1")}if(e.length<=7){throw new c("bad payload2")}}if(7===y){d=1,
g=256*e[6]+e[7],r.zclheader.attID=s(g,4),r.zclheader.status=e[4],r.zclheader.report_parameters={};var Ve=p(e[5])
...
r.zclheader.report_parameters.no_hearde_port=Ve[6],r.zclheader.report_parameters.batch=Ve[7]}if(9===y){d=1,
...
r.zclheader.max.unit="minutes"),r.lora.payload="",80===h&&6===g){var Be=e[13]/5,Ge=0;for(;Be>0;){
...
return{data:u.zclheader,warning:r}}if(1===d[1]){if(void 0===u.zclheader.data){var _=[],v=!0,m=0;for(;v;){
var g=Object.keys(u.data)[m];if(void 0===g){v=!1;break}_.push({variable:g,value:u.data[g],date:e.recvTime}),m++}return{
data:_,type:"standard",warning:r}}return{data:{variable:"read reporting configuration response status",
value:u.zclheader.data,date:e.recvTime},warning:r}}}if(void 0!==u.zclheader){if(void 0!==t){
var y=u.zclheader.endpoint,h=!0,b=0,z=[],w="";for(;h;){var S=Object.keys(u.data)[b];if(void 0===S){h=!1;break}
void 0===t[S]?z.push({variable:S,value:u.data[S],date:e.recvTime}):(w=t[S][y],"NA"===w?z.push({variable:w,value:"NA",
date:e.recvTime}):z.push({variable:w,value:u.data[S],date:e.recvTime})),b++}return{data:z,type:"standard",warning:r}}
throw new c("bad decoding")}return{type:u.batch.report,payload:u.lora.payload}}}},993:function(e){e.exports={
main_or_external_voltage:"V"}}},t={},a=function a(r){var n=t[r];if(void 0!==n){return n.exports}var i=t[r]={exports:{}}
;return e[r].call(i.exports,i,i.exports,a),i.exports}(902);driver=a}()
