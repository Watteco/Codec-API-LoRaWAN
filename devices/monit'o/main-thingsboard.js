/*monit'o v1.1.8*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
function ownKeys(e,t){var a=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e)
;t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),a.push.apply(a,r)}return a}
function _objectSpread(e){var t=1;for(;t<arguments.length;t++){var a=null!=arguments[t]?arguments[t]:{}
...
return("string"===t?String:Number)(e)}function __FAIL__(e){var t=e&&e.message?e.message:String(e)
;if("undefined"!=typeof v){v.causesMessages&&v.causesMessages.push(t);v.error=t}return null}var driver;!function(){
var e={134:function(e,t,a){var r=a(174),n=a(455),i=[3,[{taglbl:0,resol:.02,sampletype:12,lblname:"0-100_mV",divide:1},{
taglbl:1,resol:17,sampletype:12,lblname:"0-70_V",divide:1},{taglbl:2,resol:100,sampletype:6,lblname:"battery_voltage",
divide:1e3},{taglbl:3,resol:100,sampletype:6,lblname:"external_level",divide:1e3}]],o={analog:["0-100_mV","0-70_V"]}
...
d.encodeDownlink=u,d.encodePayload=p},174:function(e,t,a){var r=a(907),n=a(652);function i(e){
var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};var a=null==(r=e)?{}:Array.isArray(r)?{samples:r
}:"object"==_typeof(r)?r:"string"==typeof r||"number"==typeof r?{value:r}:{};var r
;if(!a.samples||!Array.isArray(a.samples)){return o(a,t)}var n=a.samples,i={};n.forEach(function(e){
...
455:function(e){e.exports={disposable_battery_voltage:"V","0-100_mV":"mV","0-70_V":"mV",battery_voltage:"V",
external_level:"V"}},652:function(e){var t=[];t[0]=0,t[1]=1,t[2]=4,t[3]=4,t[4]=8,t[5]=8,t[6]=16,t[7]=16,t[8]=24,t[9]=24,
t[10]=32,t[11]=32,t[12]=32;var a=[[{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{sz:3,lbl:5},{sz:4,lbl:9},{sz:5,lbl:17},{sz:6,
lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{sz:11,lbl:1027},{sz:11,lbl:1028},{sz:11,lbl:1029
},{sz:11,lbl:1030},{sz:11,lbl:1031}],[{sz:7,lbl:111},{sz:5,lbl:26},{sz:4,lbl:12},{sz:3,lbl:3},{sz:3,lbl:7},{sz:2,lbl:2
},{sz:2,lbl:0},{sz:3,lbl:2},{sz:6,lbl:54},{sz:9,lbl:443},{sz:9,lbl:441},{sz:10,lbl:885},{sz:10,lbl:884},{sz:10,lbl:880
},{sz:11,lbl:1763},{sz:11,lbl:1762}],[{sz:4,lbl:9},{sz:3,lbl:5},{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{sz:5,lbl:17},{
sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{sz:11,lbl:1027},{sz:11,lbl:1028},{sz:11,
lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}]];function r(e,t,a,r){return{uncompressSamples:[{data_relative_timestamp:r,
data:{value:s(e,t),label:a}}],codingType:0,codingTable:0,resolution:null}}function n(e,t){var a=0;for(;a<e.length;a++){
...
;var b=function(e,t,a,r,o,s,d,c,l){var p={reportCauses:[],causesMessages:[]}
...
;P=D.function_type||s,T=D.size||d,M=D.divider||c,N=D.name||"FieldUndef !"}h=m(P,T,M),"threshold"===g.mode&&(z=m(P,T,M))}
...
}return p}(e,t,a,r,s,v,m,c,_);o.zclheader.alarmmsg=b.causesMessages}}e.exports={normalisation_standard:function(e,t){
...
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,_(b,y,g,e,r,z+2,k,100,"int")}
...
;r.data.humidity=(256*e[z]+e[z+1])/100,_(b,y,g,e,r,z+2,A,100,"none")}
...
;r.data.index=256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3],_(b,y,g,e,r,z+4,V,1,"none")}if(15===y&&85===g){
...
var s=0;for(;s<o;s++){r=r<<8|e[t+s]}return a>=40&&a<=43?n(r,o):r}(e,z,J),_(b,y,g,e,r,z+Math.ceil(l[J].size),J,1,"none")}
...
;r.data.illuminance=256*e[z]+e[z+1],_(b,y,g,e,r,z+2,Te,1,"none")}if(1027===y&&0===g){var Me=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),_(b,y,g,e,r,z+2,Me,1,"int")}if(1030===y&&0===g){var De=e[z-1]
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,De,1,"none")}if(32850===y&&0===g){var Ce=z
...
}else if(32768===g){var Ve=r.data.params={};Ve.WaitFreq_Hz=o(e,Ee,"U16")/10,Ee+=2,Ve.AcqFreq_Hz=o(e,Ee,"U16")/10,Ee+=2
;var Fe=o(e,Ee,"U16");Ee+=2,32768&Fe&&(Fe=60*(-32769&Fe)),Ve.NewWaitDelay_s=32768&Fe?Fe=60*(-32769&Fe):Fe,
Ve.MaxAcqDuration_ms=o(e,Ee,"U16"),Ee+=2,Ve.Threshold_X_G=o(e,Ee,"U16")/100,Ee+=2,Ve.Threshold_Y_G=o(e,Ee,"U16")/100,
Ee+=2,Ve.Threshold_Z_G=o(e,Ee,"U16")/100,Ee+=2,Ve.OverThrsh_Dt_ms=o(e,Ee,"U16"),Ee+=2,Ve.UnderThrsh_Dt_ms=o(e,Ee,"U16"),
Ee+=2,Ve.Range_G=o(e,Ee,"U16")/100,Ee+=2,Ve.FilterSmoothCoef=o(e,Ee,"U8"),Ee+=1,Ve.FilterGainCoef=o(e,Ee,"U8"),Ee+=1,
Ve=r.data.Params.working_modes={},Ve.SignalEachAcq=128&e[Ee]?"true":"false",Ve.RstAftStdRpt_X=1&e[Ee]?"true":"false",
Ve.RstAftStdRpt_Y=2&e[Ee]?"true":"false",Ve.RstAftStdRpt_7=4&e[Ee]?"true":"false"}}var qe=Object.keys(r.data)[0]
;if(void 0===r.data[qe]){throw new c("bad payload1")}if(e.length<=7){throw new c("bad payload2")}}if(7===b){d=1,
...
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(134)
