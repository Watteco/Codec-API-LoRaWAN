/*clos'o v1.1.7*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
278:function(e,t,a){var r=a(174),n=a(741),i=[],o={pin_state:["violation_detection","open"]};function s(e){
...
batch_counter:c.batch_counter,samples:l}}}},741:function(e){e.exports={disposable_battery_voltage:"V",
debounce_period:"ms",poll_period:"ms"}},839:function(e){e.exports={UintToInt:function(e,t){if(t<1||t>4){
...
;P=D.function_type||s,T=D.size||d,M=D.divider||c,N=D.name||"FieldUndef !"}b=m(P,T,M),"threshold"===g.mode&&(z=m(P,T,M))}
...
r.data.date+=String.fromCharCode(e[z+1+M])}}if(0===h&&16===g){var D=e[z];r.data.position="";var C=0;for(;C<D;C++){
...
;r.data.pressure=n(256*e[z]+e[z+1],2),_(y,h,g,e,r,z+2,Me,1,"int")}if(1030===h&&0===g){var De=e[z-1]
;r.data.occupancy=!!e[z],_(y,h,g,e,r,z+1,De,1,"none")}if(32850===h&&0===g){var Ce=z
...
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(278)
