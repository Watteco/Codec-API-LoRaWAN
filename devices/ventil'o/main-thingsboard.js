/*ventil'o v1.1.7*/function _readOnlyError(e){throw new TypeError('"'+e+'" is read-only')}function _defineProperties(e,t){
...
batch_counter:l.batch_counter,samples:c}}}},748:function(e,t,a){var r=a(174),n=a(924),i=[3,[{taglbl:0,resol:1,
sampletype:7,lblname:"mean_differential_pressure_since_last_report"},{taglbl:1,resol:1,sampletype:7,
lblname:"minimal_differential_pressure_since_last_report"},{taglbl:2,resol:1,sampletype:7,
lblname:"maximal_differential_pressure_since_last_report"},{taglbl:3,resol:1,sampletype:6,lblname:"battery_voltage",
divide:1e3},{taglbl:4,resol:10,sampletype:7,lblname:"temperature",divide:100},{taglbl:5,resol:1,sampletype:7,
lblname:"differential_pressure"},{taglbl:6,resol:1,sampletype:10,lblname:"index",divide:1},{taglbl:7,resol:1,
sampletype:1,lblname:"state",divide:1}]],o={};function s(e){
...
;if(f){if(_>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading FI.")}var U=s,T=d,M=l
;if(g.fieldIndex=0,null!=c&&!0===c&&(P=r[_++],g.fieldIndex=P,u[t]&&u[t][a]&&u[t][a][P])){var E=u[t][a][P]
;U=E.function_type||s,T=E.size||d,M=E.divider||l,N=E.name||"FieldUndef !"}h=m(U,T,M),"threshold"===g.mode&&(z=m(U,T,M))}
...
r.data.manufacturer+=String.fromCharCode(e[z+1+I])}}if(0===y&&5===g){var P=e[z];r.data.model="";var U=0;for(;U<P;U++){
r.data.model+=String.fromCharCode(e[z+1+U])}}if(0===y&&6===g){var T=e[z];r.data.date="";var M=0;for(;M<T;M++){
r.data.date+=String.fromCharCode(e[z+1+M])}}if(0===y&&16===g){var E=e[z];r.data.position="";var C=0;for(;C<E;C++){
r.data.position+=String.fromCharCode(e[z+1+C])}}if(0===y&&32769===g){var D=e[z];r.data.application_name="";var j=0
;for(;j<D;j++){r.data.application_name+=String.fromCharCode(e[z+1+j])}}if(1026===y&&0===g){var k=e[z-1]
...
;r.data.index=256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3],_(b,y,g,e,r,z+4,F,1,"none")}if(15===y&&85===g){
var q=e[z-1];r.data.pin_state=!!e[z],_(b,y,g,e,r,z+1,q,1,"none")}
...
_(b,y,g,e,r,z+1,H,1,"none")}if(6===y&&0===g){var V=e[z];r.data.output=1===V?"ON":"OFF"}if(32776===y&&0===g){var R=e[z-1]
...
r.data.angle=n(256*e[Oe+1]+e[Oe+2],2),_(b,y,g,e,r,Oe+3,Ie,1,"multistate",!0)}if(32781===y&&0===g){var Pe=e[z-1]
...
r.data.Irms_c=n(256*e[z+15]+e[z+16],2)/10,r.data.angle_c=n(256*e[z+17]+e[z+18],2),_(b,y,g,e,r,z+19,Pe,1,"multistate",!0)
}if(32780===y&&0===g){var Ue=e[z-1];r.data.concentration=256*e[z]+e[z+1],_(b,y,g,e,r,z+2,Ue,1,"none")}
...
;r.data.pressure=n(256*e[z]+e[z+1],2),_(b,y,g,e,r,z+2,Me,1,"int")}if(1030===y&&0===g){var Ee=e[z-1]
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,Ee,1,"none")}if(32850===y&&0===g){var Ce=z
...
var De=z+1;if(0===g){var je=r.data.last={};je.NbTriggedAcq=o(e,De,"U32"),De+=4,je.Mean_X_G=o(e,De,"U16")/100,De+=2,
je.Max_X_G=o(e,De,"U16")/100,De+=2,je.Dt_X_ms=o(e,De,"U16"),De+=2,je.Mean_Y_G=o(e,De,"U16")/100,De+=2,
je.Max_Y_G=o(e,De,"U16")/100,De+=2,je.Dt_Y_ms=o(e,De,"U16"),De+=2,je.Mean_Z_G=o(e,De,"U16")/100,De+=2,
je.Max_Z_G=o(e,De,"U16")/100,De+=2,je.Dt_Z_ms=o(e,De,"U16")}else if(1===g||2===g||3===g){
var ke=1===g?"Stats_X":2===g?"Stats_Y":"Stats_Z",Ae=r.data[ke]={};Ae.NbAcq=o(e,De,"U16"),De+=2,
Ae.MinMean_G=o(e,De,"U16")/100,De+=2,Ae.MinMax_G=o(e,De,"U16")/100,De+=2,Ae.MinDt=o(e,De,"U16"),De+=2,
Ae.MeanMean_G=o(e,De,"U16")/100,De+=2,Ae.MeanMax_G=o(e,De,"U16")/100,De+=2,Ae.MeanDt=o(e,De,"U16"),De+=2,
Ae.MaxMean_G=o(e,De,"U16")/100,De+=2,Ae.MaxMax_G=o(e,De,"U16")/100,De+=2,Ae.MaxDt=o(e,De,"U16"),De+=2
}else if(32768===g){var Fe=r.data.params={};Fe.WaitFreq_Hz=o(e,De,"U16")/10,De+=2,Fe.AcqFreq_Hz=o(e,De,"U16")/10,De+=2
;var qe=o(e,De,"U16");De+=2,32768&qe&&(qe=60*(-32769&qe)),Fe.NewWaitDelay_s=32768&qe?qe=60*(-32769&qe):qe,
...
Fe.RstAftStdRpt_Y=2&e[De]?"true":"false",Fe.RstAftStdRpt_7=4&e[De]?"true":"false"}}var He=Object.keys(r.data)[0]
;if(void 0===r.data[He]){throw new l("bad payload1")}if(e.length<=7){throw new l("bad payload2")}}if(7===b){d=1,
...
main_or_external_voltage:"V",solar_harvesting_voltage:"V",temperature:"Cel",differential_pressure:"Pa",
mean_differential_pressure_since_last_report:"Pa",minimal_differential_pressure_since_last_report:"Pa",
maximal_differential_pressure_since_last_report:"Pa",battery_voltage:"V"}}},t={},a=function a(r){var n=t[r]
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(748)
