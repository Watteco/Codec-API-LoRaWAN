/*alt'o v1.1.1*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
187:function(e){e.exports={disposable_battery_voltage:"V",Tilt:"deg",ACCmg:"mg",distance:"m",battery_voltage:"V",
acc_temperature:"Cel"}},630:function(e,t,a){var r=a(174),n=a(187),i=[3,[{taglbl:0,resol:1,sampletype:6,lblname:"ACCmg",
divide:1},{taglbl:1,resol:.1,sampletype:12,lblname:"Tilt",divide:1},{taglbl:2,resol:.001,sampletype:12,
lblname:"distance",divide:1},{taglbl:3,resol:1,sampletype:6,lblname:"magnitude",divide:1},{taglbl:4,resol:.1,
sampletype:6,lblname:"battery_voltage",divide:1e3},{taglbl:5,resol:.1,sampletype:7,lblname:"acc_temperature",divide:100
}]],o={analog:["Tilt","distance"],number:["ACCmg","magnitude"]};function s(e){
...
;if(f){if(_>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading FI.")}var P=s,T=d,C=c
;if(g.fieldIndex=0,null!=l&&!0===l&&(U=r[_++],g.fieldIndex=U,u[t]&&u[t][a]&&u[t][a][U])){var M=u[t][a][U]
;P=M.function_type||s,T=M.size||d,C=M.divider||c,N=M.name||"FieldUndef !"}h=m(P,T,C),"threshold"===g.mode&&(z=m(P,T,C))}
if("threshold"===g.mode&&f){if(_>=r.length){
throw new Error("Alarm decoding: Unexpected end of data before reading Occ.")}var A=r[_++];if(w=A,A>0&&128&A){
...
r.data.model+=String.fromCharCode(e[z+1+P])}}if(0===y&&6===g){var T=e[z];r.data.date="";var C=0;for(;C<T;C++){
r.data.date+=String.fromCharCode(e[z+1+C])}}if(0===y&&16===g){var M=e[z];r.data.position="";var A=0;for(;A<M;A++){
r.data.position+=String.fromCharCode(e[z+1+A])}}if(0===y&&32769===g){var D=e[z];r.data.application_name="";var E=0
;for(;E<D;E++){r.data.application_name+=String.fromCharCode(e[z+1+E])}}if(1026===y&&0===g){var j=e[z-1]
...
;r.data.illuminance=256*e[z]+e[z+1],_(b,y,g,e,r,z+2,Te,1,"none")}if(1027===y&&0===g){var Ce=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),_(b,y,g,e,r,z+2,Ce,1,"int")}if(1030===y&&0===g){var Me=e[z-1]
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,Me,1,"none")}if(32850===y&&0===g){var Ae=z
;r.data.frequency=(n(256*e[Ae+1]+e[Ae+2],2)+22232)/1e3,Ae+=2,r.data.frequency_min=(n(256*e[Ae+1]+e[Ae+2],2)+22232)/1e3,
Ae+=2,r.data.frequency_max=(n(256*e[Ae+1]+e[Ae+2],2)+22232)/1e3,Ae+=2,r.data.Vrms=n(256*e[Ae+1]+e[Ae+2],2)/10,Ae+=2,
r.data.Vrms_min=n(256*e[Ae+1]+e[Ae+2],2)/10,Ae+=2,r.data.Vrms_max=n(256*e[Ae+1]+e[Ae+2],2)/10,Ae+=2,
r.data.Vpeak=n(256*e[Ae+1]+e[Ae+2],2)/10,Ae+=2,r.data.Vpeak_min=n(256*e[Ae+1]+e[Ae+2],2)/10,Ae+=2,
r.data.Vpeak_max=n(256*e[Ae+1]+e[Ae+2],2)/10,Ae+=2,r.data.over_voltage=n(256*e[Ae+1]+e[Ae+2],2),Ae+=2,
r.data.sag_voltage=n(256*e[Ae+1]+e[Ae+2],2),Ae+=2,r.data.brownout_number=n(256*e[Ae+1]+e[Ae+2],2)}if(32783===y){
var De=z+1;if(0===g){var Ee=r.data.last={};Ee.NbTriggedAcq=o(e,De,"U32"),De+=4,Ee.Mean_X_G=o(e,De,"U16")/100,De+=2,
Ee.Max_X_G=o(e,De,"U16")/100,De+=2,Ee.Dt_X_ms=o(e,De,"U16"),De+=2,Ee.Mean_Y_G=o(e,De,"U16")/100,De+=2,
Ee.Max_Y_G=o(e,De,"U16")/100,De+=2,Ee.Dt_Y_ms=o(e,De,"U16"),De+=2,Ee.Mean_Z_G=o(e,De,"U16")/100,De+=2,
Ee.Max_Z_G=o(e,De,"U16")/100,De+=2,Ee.Dt_Z_ms=o(e,De,"U16")}else if(1===g||2===g||3===g){
