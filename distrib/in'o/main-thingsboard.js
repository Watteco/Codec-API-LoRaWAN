...
;r.data.firmware+="."+S.toString()}if(0===y&&3===g){var x=e[z];r.data.kernel="";var O=0;for(;O<x;O++){
r.data.kernel+=String.fromCharCode(e[z+1+O])}}if(0===y&&4===g){var N=e[z];r.data.manufacturer="";var P=0;for(;P<N;P++){
r.data.manufacturer+=String.fromCharCode(e[z+1+P])}}if(0===y&&5===g){var I=e[z];r.data.model="";var U=0;for(;U<I;U++){
r.data.model+=String.fromCharCode(e[z+1+U])}}if(0===y&&6===g){var T=e[z];r.data.date="";var E=0;for(;E<T;E++){
r.data.date+=String.fromCharCode(e[z+1+E])}}if(0===y&&16===g){var M=e[z];r.data.position="";var D=0;for(;D<M;D++){
r.data.position+=String.fromCharCode(e[z+1+D])}}if(0===y&&32769===g){var C=e[z];r.data.application_name="";var j=0
...
_(h,y,g,e,r,z+33,xe,1,"multistate",!0)}else if(32784===y&&1===g){var Oe=e[z-1]
...
_(h,y,g,e,r,z+33,Oe,1,"multistate",!0)}if(32779===y&&0===g){var Ne=z;var Pe=e[Ne-1]
;r.data.Vrms=n(256*e[Ne+1]+e[Ne+2],2)/10,Ne+=2,r.data.Irms=n(256*e[Ne+1]+e[Ne+2],2)/10,Ne+=2,
r.data.angle=n(256*e[Ne+1]+e[Ne+2],2),_(h,y,g,e,r,Ne+3,Pe,1,"multistate",!0)}if(32781===y&&0===g){var Ie=e[z-1]
...
r.data.Irms_c=n(256*e[z+15]+e[z+16],2)/10,r.data.angle_c=n(256*e[z+17]+e[z+18],2),_(h,y,g,e,r,z+19,Ie,1,"multistate",!0)
}if(32780===y&&0===g){var Ue=e[z-1];r.data.concentration=256*e[z]+e[z+1],_(h,y,g,e,r,z+2,Ue,1,"none")}
if(32780===y&&1===g&&(r.data.analog=e[z]),32780===y&&2===g&&(r.data.analog=e[z]),1024===y&&0===g){var Te=e[z-1]
;r.data.illuminance=256*e[z]+e[z+1],_(h,y,g,e,r,z+2,Te,1,"none")}if(1027===y&&0===g){var Ee=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),_(h,y,g,e,r,z+2,Ee,1,"int")}if(1030===y&&0===g){var Me=e[z-1]
;r.data.occupancy=!!e[z],_(h,y,g,e,r,z+1,Me,1,"none")}if(32850===y&&0===g){var De=z
