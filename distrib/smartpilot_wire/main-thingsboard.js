...
;if(f){if(_>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading FI.")}var P=s,M=d,T=c
;if(g.fieldIndex=0,null!=l&&!0===l&&(U=r[_++],g.fieldIndex=U,u[t]&&u[t][a]&&u[t][a][U])){var D=u[t][a][U]
...
throw new Error("Alarm decoding: Unexpected end of data before reading Occ.")}var C=r[_++];if(w=C,C>0&&128&C){
...
r.data.model+=String.fromCharCode(e[z+1+P])}}if(0===y&&6===g){var M=e[z];r.data.date="";var T=0;for(;T<M;T++){
r.data.date+=String.fromCharCode(e[z+1+T])}}if(0===y&&16===g){var D=e[z];r.data.position="";var C=0;for(;C<D;C++){
r.data.position+=String.fromCharCode(e[z+1+C])}}if(0===y&&32769===g){var E=e[z];r.data.application_name="";var j=0
...
if(32780===y&&1===g&&(r.data.analog=e[z]),32780===y&&2===g&&(r.data.analog=e[z]),1024===y&&0===g){var Me=e[z-1]
;r.data.illuminance=256*e[z]+e[z+1],_(h,y,g,e,r,z+2,Me,1,"none")}if(1027===y&&0===g){var Te=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),_(h,y,g,e,r,z+2,Te,1,"int")}if(1030===y&&0===g){var De=e[z-1]
;r.data.occupancy=!!e[z],_(h,y,g,e,r,z+1,De,1,"none")}if(32850===y&&0===g){var Ce=z
...
r.data.sag_voltage=n(256*e[Ce+1]+e[Ce+2],2),Ce+=2,r.data.brownout_number=n(256*e[Ce+1]+e[Ce+2],2)}if(32783===y){
