/*inclin'o v1.1.8*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
239:function(e){e.exports={disposable_battery_voltage:"V",Tilt:"deg",ACCmg:"mg"}},366:function(e,t,a){
var r=a(174),n=a(239),i=[3,[{taglbl:0,resol:1,sampletype:6,lblname:"ACCmg",divide:1},{taglbl:1,resol:.1,sampletype:12,
lblname:"Tilt",divide:1e3}]],o={analog:["Tilt"]};function s(e){
...
r.data.position+=String.fromCharCode(e[z+1+D])}}if(0===y&&32769===g){var A=e[z];r.data.application_name="";var E=0
;for(;E<A;E++){r.data.application_name+=String.fromCharCode(e[z+1+E])}}if(1026===y&&0===g){var j=e[z-1]
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,_(h,y,g,e,r,z+2,j,100,"int")}
...
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(366)
