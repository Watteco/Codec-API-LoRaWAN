/*pulse_sens'o v1.1.7*/function _readOnlyError(e){throw new TypeError('"'+e+'" is read-only')}function _defineProperties(e,t){
...
var e={174:function(e,t,a){var r=a(793),n=a(929),i=[4,[{taglbl:0,resol:1,sampletype:10,lblname:"index_1",divide:1},{
taglbl:1,resol:1,sampletype:10,lblname:"index_2",divide:1},{taglbl:2,resol:1,sampletype:10,lblname:"index_3",divide:1},{
taglbl:3,resol:1,sampletype:1,lblname:"pin_state_1",divide:1},{taglbl:4,resol:1,sampletype:1,lblname:"pin_state_2",
divide:1},{taglbl:5,resol:1,sampletype:1,lblname:"pin_state_3",divide:1},{taglbl:6,resol:100,sampletype:6,
lblname:"battery_voltage",divide:1e3},{taglbl:7,resol:1,sampletype:6,lblname:"multi_state",divide:100}]],o={
...
batch_counter:c.batch_counter,samples:l}}}},793:function(e,t,a){var r=a(907),n=a(652);function i(e){
...
839:function(e){e.exports={UintToInt:function(e,t){if(t<1||t>4){throw new Error("Unsupported Size")}
...
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,Ae,1,"none")}if(32850===y&&0===g){var Ee=z
...
throw new c("bad decoding")}return{type:u.batch.report,payload:u.lora.payload}}}},929:function(e){e.exports={
disposable_battery_voltage:"V",debounce_period:"ms",poll_period:"ms",battery_voltage:"V"}}},t={},a=function a(r){
var n=t[r];if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports
}(174);driver=a}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports.driver=driver);
