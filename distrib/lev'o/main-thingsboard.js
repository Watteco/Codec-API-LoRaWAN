/*lev'o v1.1.7*/function _defineProperties(e,t){var a=0;for(;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,
...
627:function(e){e.exports={disposable_battery_voltage:"V","4-20_mA":"mA","0-10_V":"V",battery_voltage:"V",
external_power_voltage:"V"}},652:function(e){var t=[];t[0]=0,t[1]=1,t[2]=4,t[3]=4,t[4]=8,t[5]=8,t[6]=16,t[7]=16,t[8]=24,
t[9]=24,t[10]=32,t[11]=32,t[12]=32;var a=[[{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{sz:3,lbl:5},{sz:4,lbl:9},{sz:5,lbl:17
},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{sz:11,lbl:1027},{sz:11,lbl:1028},{sz:11,
lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}],[{sz:7,lbl:111},{sz:5,lbl:26},{sz:4,lbl:12},{sz:3,lbl:3},{sz:3,lbl:7},{
sz:2,lbl:2},{sz:2,lbl:0},{sz:3,lbl:2},{sz:6,lbl:54},{sz:9,lbl:443},{sz:9,lbl:441},{sz:10,lbl:885},{sz:10,lbl:884},{
sz:10,lbl:880},{sz:11,lbl:1763},{sz:11,lbl:1762}],[{sz:4,lbl:9},{sz:3,lbl:5},{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{
sz:5,lbl:17},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,lbl:1026},{sz:11,lbl:1027},{sz:11,
lbl:1028},{sz:11,lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}]];function r(e,t,a,r){return{uncompressSamples:[{
...
906:function(e,t,a){var r=a(174),n=a(627),i=[3,[{taglbl:0,resol:.004,sampletype:12,lblname:"4-20_mA",divide:1},{
taglbl:1,resol:1,sampletype:12,lblname:"0-10_V",divide:1},{taglbl:2,resol:100,sampletype:6,lblname:"battery_voltage",
divide:1e3},{taglbl:3,resol:100,sampletype:6,lblname:"external_power_voltage",divide:1e3},{taglbl:4,resol:1,
sampletype:10,lblname:"index",divide:1}]],o={analog:["4-20_mA","0-10_V"]};function s(e){
...
r.data.date+=String.fromCharCode(e[z+1+M])}}if(0===y&&16===g){var A=e[z];r.data.position="";var D=0;for(;D<A;D++){
r.data.position+=String.fromCharCode(e[z+1+D])}}if(0===y&&32769===g){var C=e[z];r.data.application_name="";var E=0
;for(;E<C;E++){r.data.application_name+=String.fromCharCode(e[z+1+E])}}if(1026===y&&0===g){var j=e[z-1]
...
;r.data.humidity=(256*e[z]+e[z+1])/100,_(b,y,g,e,r,z+2,k,100,"none")}
...
15===y&&1028===g&&(r.data.force_notify=e[z]),19===y&&85===g){var V=e[z-1];r.data.output_value=e[z],
_(b,y,g,e,r,z+1,V,1,"none")}if(6===y&&0===g){var H=e[z];r.data.output=1===H?"ON":"OFF"}if(32776===y&&0===g){var R=e[z-1]
...
;r.data.pressure=n(256*e[z]+e[z+1],2),_(b,y,g,e,r,z+2,Me,1,"int")}if(1030===y&&0===g){var Ae=e[z-1]
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,Ae,1,"none")}if(32850===y&&0===g){var De=z
...
var Ce=z+1;if(0===g){var Ee=r.data.last={};Ee.NbTriggedAcq=o(e,Ce,"U32"),Ce+=4,Ee.Mean_X_G=o(e,Ce,"U16")/100,Ce+=2,
Ee.Max_X_G=o(e,Ce,"U16")/100,Ce+=2,Ee.Dt_X_ms=o(e,Ce,"U16"),Ce+=2,Ee.Mean_Y_G=o(e,Ce,"U16")/100,Ce+=2,
Ee.Max_Y_G=o(e,Ce,"U16")/100,Ce+=2,Ee.Dt_Y_ms=o(e,Ce,"U16"),Ce+=2,Ee.Mean_Z_G=o(e,Ce,"U16")/100,Ce+=2,
Ee.Max_Z_G=o(e,Ce,"U16")/100,Ce+=2,Ee.Dt_Z_ms=o(e,Ce,"U16")}else if(1===g||2===g||3===g){
var je=1===g?"Stats_X":2===g?"Stats_Y":"Stats_Z",ke=r.data[je]={};ke.NbAcq=o(e,Ce,"U16"),Ce+=2,
ke.MinMean_G=o(e,Ce,"U16")/100,Ce+=2,ke.MinMax_G=o(e,Ce,"U16")/100,Ce+=2,ke.MinDt=o(e,Ce,"U16"),Ce+=2,
ke.MeanMean_G=o(e,Ce,"U16")/100,Ce+=2,ke.MeanMax_G=o(e,Ce,"U16")/100,Ce+=2,ke.MeanDt=o(e,Ce,"U16"),Ce+=2,
ke.MaxMean_G=o(e,Ce,"U16")/100,Ce+=2,ke.MaxMax_G=o(e,Ce,"U16")/100,Ce+=2,ke.MaxDt=o(e,Ce,"U16"),Ce+=2
...
Fe.RstAftStdRpt_Y=2&e[Ce]?"true":"false",Fe.RstAftStdRpt_7=4&e[Ce]?"true":"false"}}var Ve=Object.keys(r.data)[0]
;if(void 0===r.data[Ve]){throw new c("bad payload1")}if(e.length<=7){throw new c("bad payload2")}}if(7===b){d=1,
...
;if(void 0!==n){return n.exports}var i=t[r]={exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(906)
