/*toran'o_atex v1.1.7*/function _readOnlyError(e){throw new TypeError('"'+e+'" is read-only')}function _defineProperties(e,t){
...
a.hasOwnProperty(d)&&(s[d]=a[d])}var l;for(l in i){i.hasOwnProperty(l)&&!s.hasOwnProperty(l)&&(s[l]=i[l].value)}
...
;if("string"==typeof e.bytes){var d=e.bytes.replace(/[^0-9A-Fa-f]/g,""),l=[];var c=0;for(;c<d.length;c+=2){
l.push(parseInt(d.substr(c,2),16))}e.bytes=l}e.recvTime=function(e){try{if(!e){return(new Date).toISOString()}
...
;if(!isNaN(l.getTime())){return l.toISOString()}}if(void 0!==d.seconds){var c=Number(d.seconds),u=Number(d.nanos||0)
;if(!isNaN(c)){return new Date(1e3*c+Math.floor(u/1e6)).toISOString()}}}}var p=new Date(e);if(!isNaN(p.getTime())){
...
403:function(e){e.exports={disposable_battery_voltage:"V","4-20_mA":"mA","0-5_V_1":"V","0-5_V_2":"V",
"ratiometric_0-5_V_1":"V","ratiometric_0-5_V_2":"V",battery_voltage:"V"}},652:function(e){var t=[];t[0]=0,t[1]=1,t[2]=4,
t[3]=4,t[4]=8,t[5]=8,t[6]=16,t[7]=16,t[8]=24,t[9]=24,t[10]=32,t[11]=32,t[12]=32;var a=[[{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,
lbl:3},{sz:3,lbl:5},{sz:4,lbl:9},{sz:5,lbl:17},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{sz:11,
lbl:1026},{sz:11,lbl:1027},{sz:11,lbl:1028},{sz:11,lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}],[{sz:7,lbl:111},{sz:5,
lbl:26},{sz:4,lbl:12},{sz:3,lbl:3},{sz:3,lbl:7},{sz:2,lbl:2},{sz:2,lbl:0},{sz:3,lbl:2},{sz:6,lbl:54},{sz:9,lbl:443},{
sz:9,lbl:441},{sz:10,lbl:885},{sz:10,lbl:884},{sz:10,lbl:880},{sz:11,lbl:1763},{sz:11,lbl:1762}],[{sz:4,lbl:9},{sz:3,
lbl:5},{sz:2,lbl:0},{sz:2,lbl:1},{sz:2,lbl:3},{sz:5,lbl:17},{sz:6,lbl:33},{sz:7,lbl:65},{sz:8,lbl:129},{sz:10,lbl:512},{
sz:11,lbl:1026},{sz:11,lbl:1027},{sz:11,lbl:1028},{sz:11,lbl:1029},{sz:11,lbl:1030},{sz:11,lbl:1031}]]
;function r(e,t,a,r){return{uncompressSamples:[{data_relative_timestamp:r,data:{value:s(e,t),label:a}}],codingType:0,
codingTable:0,resolution:null}}function n(e,t){var a=0;for(;a<e.length;a++){if(e[a].taglbl===t.lbl){return a}}
...
return s.isCommonTimestamp?function(e,t,a,r,i,o){var s=t.getNextSample(4,8),l={},c=function(e,t,a,r){
var n=[],i=0,o=t.getNextSample(4,2);var s=0;for(;s<a;s++){var d=t.getNextBifromHi(o);if(d<=14){if(0===s){
n.push(e.series[r].uncompressSamples[0].data_relative_timestamp)}else{var l=n[s-1]
;d>0?n.push(t.getNextSample(10,d)+l+Math.pow(2,d)-1):n.push(l)}}else{n.push(t.getNextSample(10))}i=n[s]}return{
timestampCommon:n,lastTimestamp:i}}(e,t,s,a),u=c.timestampCommon,p=c.lastTimestamp;var _=0
;for(;_<i.nb_of_type_measure;_++){var f=1;l.lbl=t.getNextSample(4,o);var v=n(r,l);var m=0;for(;m<s;m++){
if(t.getNextSample(4,1)){var g=t.getNextBifromHi(e.series[v].codingTable),b={data_relative_timestamp:0,data:{}}
;if(g<=14){var y=e.series[v].uncompressSamples[e.series[v].uncompressSamples.length-1].data.value;if(g>0){
b.data.value=d(t,y,e.series[v].codingType,r[v].resol,g)}else{if(f){f=0;continue}b.data.value=y}}else{
b.data.value=t.getNextSample(r[v].sampletype)}b.data_relative_timestamp=u[m],e.series[v].uncompressSamples.push(b)}}}
return p}(e,t,a,r,s,l):function(e,t,a,r,i,s){var l={};var c=0;for(;c<i.nb_of_type_measure;c++){
l.lbl=t.getNextSample(4,s);var u=n(a,l),p=t.getNextSample(4,8);if(p){var _=t.getNextSample(4,2);var f=0;for(;f<p;f++){
...
;m.data.value=g>0?d(t,b,e.series[u].codingType,a[u].resol,g):b}else{m.data.value=t.getNextSample(a[u].sampletype)}
e.series[u].uncompressSamples.push(m)}}}return r}(e,t,r,i,s,l)}(u,p,m,s,v,_,e)),u.batch_relative_timestamp=i(p,v),
...
d=r.data_relative_timestamp,new Date(new Date(o).getTime()-1e3*(s-d)).toISOString())),n}))},[]),r}(u,s,c)
}(e.batch1,e.batch2,e.payload,s),c=[];var u=0;for(;u<l.dataset.length;u++){var p=l.dataset[u],_={
variable:p.data.label_name,value:p.data.value,date:p.data_absolute_timestamp};c.push(_)}return{
batch_counter:l.batch_counter,samples:c}}}},839:function(e){e.exports={UintToInt:function(e,t){if(t<1||t>4){
...
;r.BytesToHexStr;var l=function(e){function t(e){var a;_classCallCheck(this,t);a=_callSuper(this,t,[e]),
a.name="ValidationError";return a}_inherits(t,e);return _createClass(t)}(_wrapNativeSuper(Error));var c={16:{
...
var t="",a=e.toString(2);return t+=d(a,8),t}function _(e,t,a,r,o,s,d,l,p,_){if(138===e||10==e){
var f=c[d],v=p,m=f.size,g=f.name;void 0===v&&(v="single"===g?"float":"int8"===g||"int16"===g||"int32"===g?"int":"none")
;var b=function(e,t,a,r,o,s,d,l,c){var p={reportCauses:[],causesMessages:[]}
...
;if(f){if(_>=r.length){throw new Error("Alarm decoding: Unexpected end of data before reading FI.")}var P=s,T=d,A=l
;if(g.fieldIndex=0,null!=c&&!0===c&&(U=r[_++],g.fieldIndex=U,u[t]&&u[t][a]&&u[t][a][U])){var M=u[t][a][U]
;P=M.function_type||s,T=M.size||d,A=M.divider||l,N=M.name||"FieldUndef !"}h=m(P,T,A),"threshold"===g.mode&&(z=m(P,T,A))}
...
}return p}(e,t,a,r,s,v,m,l,_);o.zclheader.alarmmsg=b.causesMessages}}e.exports={normalisation_standard:function(e,t){
...
1===b&&(z=8,r.zclheader.status=e[6]),83===y||84===y||85===y||86===y||87===y){if("function"!=typeof a){
throw new l("TIC_Decode function not found")}r.data=a(y,g,e.slice(z+1))}if(0===y&&2===g){r.data.firmware="";var w=0
;for(;w<3;w++){r.data.firmware+=String(e[z+w]),w<2&&(r.data.firmware+=".")}var S=256*e[z+3]*256+256*e[z+4]+e[z+5]
;r.data.firmware+="."+S.toString()}if(0===y&&3===g){var x=e[z];r.data.kernel="";var N=0;for(;N<x;N++){
r.data.kernel+=String.fromCharCode(e[z+1+N])}}if(0===y&&4===g){var O=e[z];r.data.manufacturer="";var I=0;for(;I<O;I++){
r.data.manufacturer+=String.fromCharCode(e[z+1+I])}}if(0===y&&5===g){var U=e[z];r.data.model="";var P=0;for(;P<U;P++){
r.data.model+=String.fromCharCode(e[z+1+P])}}if(0===y&&6===g){var T=e[z];r.data.date="";var A=0;for(;A<T;A++){
r.data.date+=String.fromCharCode(e[z+1+A])}}if(0===y&&16===g){var M=e[z];r.data.position="";var E=0;for(;E<M;E++){
r.data.position+=String.fromCharCode(e[z+1+E])}}if(0===y&&32769===g){var D=e[z];r.data.application_name="";var C=0
;for(;C<D;C++){r.data.application_name+=String.fromCharCode(e[z+1+C])}}if(1026===y&&0===g){var j=e[z-1]
;r.data.temperature=n(256*e[z]+e[z+1],2)/100,_(b,y,g,e,r,z+2,j,100,"int")}
if(1026===y&&1===g&&(r.data.min_temperature=n(256*e[z]+e[z+1],2)/100),
1026===y&&2===g&&(r.data.max_temperature=n(256*e[z]+e[z+1],2)/100),1029===y&&0===g){var V=e[z-1]
;r.data.humidity=(256*e[z]+e[z+1])/100,_(b,y,g,e,r,z+2,V,100,"none")}
if(1029===y&&1===g&&(r.data.min_humidity=(256*e[z]+e[z+1])/100),
1029===y&&2===g&&(r.data.max_humidity=(256*e[z]+e[z+1])/100),15===y&&1026===g){var k=e[z-1]
;r.data.index=256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3],_(b,y,g,e,r,z+4,k,1,"none")}if(15===y&&85===g){
var F=e[z-1];r.data.pin_state=!!e[z],_(b,y,g,e,r,z+1,F,1,"none")}
...
15===y&&1028===g&&(r.data.force_notify=e[z]),19===y&&85===g){var q=e[z-1];r.data.output_value=e[z],
_(b,y,g,e,r,z+1,q,1,"none")}if(6===y&&0===g){var H=e[z];r.data.output=1===H?"ON":"OFF"}if(32776===y&&0===g){var R=e[z-1]
;r.data.differential_pressure=256*e[z]+e[z+1],_(b,y,g,e,r,z+2,R,1,"none")}if(32773===y&&0===g){var B=e[z-1]
...
r.data.pin_state_10=!(2&~e[z]),_(b,y,g,e,r,z+2,B,100,"none")}
...
;r.data.analog=i(256*e[z]*256*256+256*e[z+1]*256+256*e[z+2]+e[z+3]),_(b,y,g,e,r,z+4,G,1,"float")}
...
12===y&&32772===g){var Y={};var L=p(e[z]),K=p(e[z+1]),X=2*L[0]+L[1];0===X&&(Y.mode="idle"),1===X&&(Y.mode="chock"),
...
if(32782===y&&0===g){var J=e[z-1];r.data.number=function(e,t,a){var r=0,o=0;switch(a){case 8:case 24:case 32:case 40:
...
var s=0;for(;s<o;s++){r=r<<8|e[t+s]}return a>=40&&a<=43?n(r,o):r}(e,z,J),_(b,y,g,e,r,z+Math.ceil(c[J].size),J,1,"none")}
...
}}if(32777===y&&0===g){var te=e[z+2]<<8|e[z+3];r.data.modbus_frame_series_sent=e[z+1],
...
var o="modbus_datasize_EP".concat(i),s=n.data[o];var d=0;for(;d<s;d++){var l=r[t+d].toString(16).toUpperCase()
;1===l.length&&(l="0"+l),n.data["modbus_payload_EP".concat(i)]+=l}t+=s}return t}var re=z+4;var ne=0;var ie=0
...
;var le=e[z+2];var ce=0;for(;ce<le;ce++){var ue={};ue.endpoint=e[z+3+7*ce];var pe=e[z+4+7*ce];ue.input_clusters=[]
;var _e=0;for(;_e<pe;_e++){ue.input_clusters[_e]=s(256*e[z+5+7*ce+2*_e]+e[z+6+7*ce+2*_e],4)}var fe=e[z+5+7*ce+2*pe]
;ue.output_clusters=[];var ve=0;for(;ve<fe;ve++){ue.output_clusters[ve]=s(256*e[z+6+7*ce+2*ve]+e[z+7+7*ce+2*ve],4)}
de[ce]=ue}r.data.configuration=de}if(80===y&&6===g){var me=z+3;var ge=e[z-1]
...
16&~e[z+2]||(r.data.tic_harvesting_voltage=(256*e[me]+e[me+1])/1e3,me+=2),_(b,y,g,e,r,me+1,ge,1e3,"multistate",!0)}
...
_(b,y,g,e,r,we+5,Se,1,"multistate",!0)}if(32784===y&&0===g){var xe=e[z-1]
...
_(b,y,g,e,r,z+33,xe,1,"multistate",!0)}else if(32784===y&&1===g){var Ne=e[z-1]
...
_(b,y,g,e,r,z+33,Ne,1,"multistate",!0)}if(32779===y&&0===g){var Oe=z;var Ie=e[Oe-1]
;r.data.Vrms=n(256*e[Oe+1]+e[Oe+2],2)/10,Oe+=2,r.data.Irms=n(256*e[Oe+1]+e[Oe+2],2)/10,Oe+=2,
r.data.angle=n(256*e[Oe+1]+e[Oe+2],2),_(b,y,g,e,r,Oe+3,Ie,1,"multistate",!0)}if(32781===y&&0===g){var Ue=e[z-1]
...
r.data.Irms_c=n(256*e[z+15]+e[z+16],2)/10,r.data.angle_c=n(256*e[z+17]+e[z+18],2),_(b,y,g,e,r,z+19,Ue,1,"multistate",!0)
}if(32780===y&&0===g){var Pe=e[z-1];r.data.concentration=256*e[z]+e[z+1],_(b,y,g,e,r,z+2,Pe,1,"none")}
if(32780===y&&1===g&&(r.data.analog=e[z]),32780===y&&2===g&&(r.data.analog=e[z]),1024===y&&0===g){var Te=e[z-1]
;r.data.illuminance=256*e[z]+e[z+1],_(b,y,g,e,r,z+2,Te,1,"none")}if(1027===y&&0===g){var Ae=e[z-1]
;r.data.pressure=n(256*e[z]+e[z+1],2),_(b,y,g,e,r,z+2,Ae,1,"int")}if(1030===y&&0===g){var Me=e[z-1]
;r.data.occupancy=!!e[z],_(b,y,g,e,r,z+1,Me,1,"none")}if(32850===y&&0===g){var Ee=z
...
r.data.sag_voltage=n(256*e[Ee+1]+e[Ee+2],2),Ee+=2,r.data.brownout_number=n(256*e[Ee+1]+e[Ee+2],2)}if(32783===y){
...
var je=1===g?"Stats_X":2===g?"Stats_Y":"Stats_Z",Ve=r.data[je]={};Ve.NbAcq=o(e,De,"U16"),De+=2,
Ve.MinMean_G=o(e,De,"U16")/100,De+=2,Ve.MinMax_G=o(e,De,"U16")/100,De+=2,Ve.MinDt=o(e,De,"U16"),De+=2,
Ve.MeanMean_G=o(e,De,"U16")/100,De+=2,Ve.MeanMax_G=o(e,De,"U16")/100,De+=2,Ve.MeanDt=o(e,De,"U16"),De+=2,
Ve.MaxMean_G=o(e,De,"U16")/100,De+=2,Ve.MaxMax_G=o(e,De,"U16")/100,De+=2,Ve.MaxDt=o(e,De,"U16"),De+=2
}else if(32768===g){var ke=r.data.params={};ke.WaitFreq_Hz=o(e,De,"U16")/10,De+=2,ke.AcqFreq_Hz=o(e,De,"U16")/10,De+=2
;var Fe=o(e,De,"U16");De+=2,32768&Fe&&(Fe=60*(-32769&Fe)),ke.NewWaitDelay_s=32768&Fe?Fe=60*(-32769&Fe):Fe,
ke.MaxAcqDuration_ms=o(e,De,"U16"),De+=2,ke.Threshold_X_G=o(e,De,"U16")/100,De+=2,ke.Threshold_Y_G=o(e,De,"U16")/100,
De+=2,ke.Threshold_Z_G=o(e,De,"U16")/100,De+=2,ke.OverThrsh_Dt_ms=o(e,De,"U16"),De+=2,ke.UnderThrsh_Dt_ms=o(e,De,"U16"),
De+=2,ke.Range_G=o(e,De,"U16")/100,De+=2,ke.FilterSmoothCoef=o(e,De,"U8"),De+=1,ke.FilterGainCoef=o(e,De,"U8"),De+=1,
ke=r.data.Params.working_modes={},ke.SignalEachAcq=128&e[De]?"true":"false",ke.RstAftStdRpt_X=1&e[De]?"true":"false",
ke.RstAftStdRpt_Y=2&e[De]?"true":"false",ke.RstAftStdRpt_7=4&e[De]?"true":"false"}}var qe=Object.keys(r.data)[0]
;if(void 0===r.data[qe]){throw new l("bad payload1")}if(e.length<=7){throw new l("bad payload2")}}if(7===b){d=1,
...
r.zclheader.report_parameters.no_hearde_port=He[6],r.zclheader.report_parameters.batch=He[7]}if(9===b){d=1,
...
throw new l("bad decoding")}return{type:u.batch.report,payload:u.lora.payload}}}},978:function(e,t,a){
var r=a(174),n=a(403),i=[4,[{taglbl:0,resol:1,sampletype:10,lblname:"index_1",divide:1},{taglbl:1,resol:1,sampletype:10,
lblname:"index_2",divide:1},{taglbl:2,resol:1,sampletype:10,lblname:"index_3",divide:1},{taglbl:3,resol:1,sampletype:1,
lblname:"pin_state_1",divide:1},{taglbl:4,resol:1,sampletype:1,lblname:"pin_state_2",divide:1},{taglbl:5,resol:1,
sampletype:1,lblname:"pin_state_3",divide:1},{taglbl:6,resol:.004,sampletype:12,lblname:"4-20_mA",divide:1},{taglbl:7,
resol:1,sampletype:12,lblname:"0-5_V_1",divide:1},{taglbl:8,resol:1,sampletype:12,lblname:"0-5_V_2",divide:1},{taglbl:9,
resol:1,sampletype:12,lblname:"ratiometric_0-5_V_1",divide:1},{taglbl:10,resol:1,sampletype:12,
lblname:"ratiometric_0-5_V_2",divide:1},{taglbl:11,resol:100,sampletype:6,lblname:"battery_voltage",divide:1}]],o={
analog:["4-20_mA","0-5_V_1","0-5_V_2 ","ratiometric_0-5_V_1","ratiometric_0-5_V_2"],
index:["index_1","index_2","index_3"],pin_state:["pin_state_1","pin_state_2","pin_state_3"],pin_state_4:["NA"],
pin_state_5:["NA"],pin_state_6:["NA"],pin_state_7:["NA"],pin_state_8:["NA"],pin_state_9:["NA"],pin_state_10:["NA"]}
...
;var d="undefined"!=typeof globalThis?globalThis:this;d.decodeUplink=s;var l=a(871);var c={};function u(e){
return l.watteco_encodeDownlink({dlFrames:c},e)}t.encodeDownlink=u;var p=l.encodePayload;t.encodePayload=p,
d.encodeDownlink=u,d.encodePayload=p}},t={},a=function a(r){var n=t[r];if(void 0!==n){return n.exports}var i=t[r]={
exports:{}};return e[r].call(i.exports,i,i.exports,a),i.exports}(978);driver=a}()
